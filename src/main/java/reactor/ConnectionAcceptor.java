...
public class ConnectionAcceptor {
	 ...
	 */
	public ConnectionAcceptor(ServerSocketChannel ssChannel, ReactorData<String> data) {
	...
	public void accept() throws IOException {
		...
		if (sChannel != null) {
			...
			ConnectionHandlerReactor handler = ConnectionHandlerReactor.create(sChannel, _data, key);
